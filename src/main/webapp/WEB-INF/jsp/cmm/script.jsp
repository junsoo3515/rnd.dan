...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/jqgrid/ui.jqgrid.barun.css'/>" />
...
<script src="<c:url value='/js/jqgrid/i18n/grid.locale-en.js'/>" type="text/javascript"></script>
<script src="<c:url value='/js/jqgrid/jquery.jqGrid.min.js'/>" type="text/javascript"></script>
