package kr.co.ucp.dan.cmm.service.impl;

import egovframework.rte.psl.dataaccess.EgovAbstractMapper;
import kr.co.ucp.dan.cmm.service.FileVO;
...
public class FileManageDAO extends EgovAbstractMapper {
    ...
    public int getMaxFileSN(FileVO fvo) throws Exception {
    	//jwkim -- mybatis(EgovAbstractMapper) 로 변경 하면서 에러 발생하여 수정 
	...
	return (FileVO)selectOne("EgovFile_SQL.selectFileInf", fvo);
    }
